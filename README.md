...
1. Revisa los correos nuevos de `areamarketing@inelinc.com`.
...
- Requiere 3 connectors de Composio activos: **Outlook**, **Microsoft Teams**, **Excel** (todos sobre la cuenta de Microsoft de Natalie Aguirre / `areamarketing@inelinc.com`).
